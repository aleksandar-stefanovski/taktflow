...
const PlansSchema = z.object({
  ...
  PLAN_STARTER_MAX_PAYLOAD_BYTES:     z.coerce.number().int().positive(),
  PLAN_GROWTH_MAX_PAYLOAD_BYTES:      z.coerce.number().int().positive(),
  PLAN_BUSINESS_MAX_PAYLOAD_BYTES:    z.coerce.number().int().positive(),
  PLAN_ENTERPRISE_MAX_PAYLOAD_BYTES:  z.coerce.number().int().positive(),
