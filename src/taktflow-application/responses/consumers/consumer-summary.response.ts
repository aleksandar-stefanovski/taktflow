import type { Consumer, ConsumerType, ConsumerStatus } from '@taktflow/domain/entities/consumer.js';
...
export class ConsumerSummaryResponse {
  ...
  static mapFromEntity(consumer: Consumer): ConsumerSummaryResponse {
